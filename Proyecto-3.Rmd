...
Finalmente, para poder categorizar aquellos registros que fueron realizados a pie y en bicicleta se converitra la variable "type" a valores de 1 para aquellas que sean en bicicleta y 0 para aquellas que son a pie.
...
Entonces por medio de este condicional sera posible identificar si las actividades fueron ingresadas de manera correcta o erronea.
...
Finalmente, se procede a mostrar cuantos registros fueron ingresados de manera erronea, estos son 4866.
